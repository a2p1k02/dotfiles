...
/* tagging */
static const char *tags[] = { "web", "tg", "term", "misc", "dev", "chat" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "18", "-g", "6",  NULL };
